        ...
        <div className="row align-items-center g-4 g-lg-5">
          ...
          <div className="col-lg-6 text-start">
            ...
            <div className="heroabout-desc-content mb-4">
              ...
              <p className="heroabout-desc">
                Led by <strong>Dr. Rudra Mohanty, Managing Trustee</strong>, the Trust works with compassion, honesty, and dedication to help people in need and make a meaningful difference in their lives.
              </p>
              <p className="heroabout-desc">
            ...
            <div className="heroabout-action-row">
              ...
              <div className="heroabout-founder">
                ...
                <div className="founder-text-wrap">
                  ...
                  <p className="founder-role">Founder & Managing Trustee</p>
                </div>
              </div>
            </div>
          </div>
